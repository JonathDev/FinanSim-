...
function horaire_brut() {
  ...
  document.getElementById("annuel_brut").value=Math.round(horaire_brut*151.667*temps_travail*prime)*12;
  ...
  document.getElementById("annuel_net").value=Math.round(horaire_net*151.667*temps_travail*prime)*12;
  calcul_taux()
  }
...
function mensuel_brut() {
  ...
  document.getElementById("annuel_brut").value=Math.round(mensuel_brut*12*prime);
  const horaire_brut=document.getElementById("horaire_brut").value;
  document.getElementById("horaire_net").value=Math.round(horaire_brut*(1-port/100));
  const horaire_net=document.getElementById("horaire_net").value;
  document.getElementById("mensuel_net").value=Math.round(horaire_net*temps_travail*151.667);
  document.getElementById("annuel_net").value=Math.round(horaire_net*temps_travail*151.667*prime)*12;
  calcul_taux()
  }

function annuel_brut() {
  const annuel_brut=document.getElementById("annuel_brut").value;
  document.getElementById("mensuel_brut").value=Math.round(annuel_brut/(12*prime));
  document.getElementById("horaire_brut").value=parseFloat((annuel_brut/(12*151.667*temps_travail*prime)).toFixed(2));
  const horaire_brut=document.getElementById("horaire_brut").value;
  document.getElementById("horaire_net").value=Math.round(horaire_brut*(1-port/100));
  const horaire_net=document.getElementById("horaire_net").value;
  document.getElementById("mensuel_net").value=Math.round(horaire_net*temps_travail*151.667);
...
function mensuel_net() {
  ...
  document.getElementById("annuel_net").value=Math.round(mensuel_net*12*prime);
...
function annuel_net() {
  ...
  document.getElementById("mensuel_net").value=Math.round(annuel_net/(12*prime));
  document.getElementById("horaire_net").value=parseFloat((annuel_net/(12*151.667*temps_travail*prime)).toFixed(2));
  const horaire_net=document.getElementById("horaire_net").value;
  document.getElementById("horaire_brut").value=Math.round(horaire_net/(1-port/100));
  const horaire_brut=document.getElementById("horaire_brut").value;
  document.getElementById("mensuel_brut").value=Math.round(horaire_brut*151.667*temps_travail);
...
function calcul_taux() {
    ...
    document.getElementById("resultat2").innerHTML=Math.round((100-taux)/100*annuel_net);
}
...
function fn_prime() {
    prime=document.getElementById("prime").value/12;
    horaire_brut();
}
...
document.getElementById("prime").addEventListener("mouseup",fn_prime);
